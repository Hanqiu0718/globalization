...
export function HomeCard() {
    ...
    return (
        <Card className="w-full border md:border-[2px] flex-col items-center justify-center mb-10">
            ...
            <CardDescription className="mt-5 text-[#212B36] md:mx-5">
                We aim to investigate people`s attitude toward globalization.
            </CardDescription>
            <CardDescription className="font-semibold text-xl border-b md:border-b-0 mt-3 text-[#212B36] md:mx-5 pb-3 md:pb-0">
                HOW LONG WILL THE RESEARCH LAST AND WHAT WILL I NEED TO DO?
            </CardDescription>
            <CardDescription className="mt-5 text-[#212B36] md:mx-5">
                Participation will take a total of about 30 mins. You will be asked to answer some questions about yourself and interact with a partner. You will also be answering demographic questions.
            ...
            <CardDescription className="mt-5 text-[#212B36] md:mx-5">
                You will receive $3.75 for your time and effort.
            </CardDescription>
            <CardDescription className="font-semibold text-xl border-b md:border-b-0 mt-3 text-[#212B36] md:mx-5 pb-3 md:pb-0">
            ...
            <Button className="md:mx-5 mb-5" variant="outline" onClick={handleYesClick} disabled={response === 'no'}>Yes</Button>
            <Button variant="outline" onClick={handleNoClick} disabled={response === 'no'}>No</Button>
            {response === 'no' && (
                <Alert>
